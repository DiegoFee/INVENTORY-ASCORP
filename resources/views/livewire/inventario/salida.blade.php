...
new class extends Component {
     ...
     * // Autor: Diego Méndez - Fecha: 21/05/2026
     */
    public function registerSalida(InventoryMovementService $service): void
    {
...
<form wire:submit="registerSalida" class="max-w-3xl space-y-6">
    @if (session('success'))
    ...
    <div class="flex items-center gap-3">
        <flux:button variant="primary" type="submit">Registrar salida</flux:button>
